...
import com.example.vmmusic.app.customview.CircularSeekBar;
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.i_like_music:// 我喜欢
                    intent = new Intent(getActivity(), HistoryorCollectionActivity.class);
                    intent.putExtra(HistoryorCollectionActivity.COLLECT, 1);
                ...
                case R.id.mine_lately:// 最近播放
                    intent = new Intent(getActivity(), HistoryorCollectionActivity.class);
                    intent.putExtra(HistoryorCollectionActivity.COLLECT, 0);
                    startActivity(intent);
                    break;
